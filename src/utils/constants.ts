...
export const navElements = [
  ...
  { path: "/join-us", title: "Join us", dropDown: true },
];

export const deviceElements = [
  { src: "/images/devices/phone.svg", title: "Phones" },
  { src: "/images/devices/tablet.svg", title: "Tablets" },
  { src: "/images/devices/laptop.svg", title: "Laptop" },
  { src: "/images/devices/smartwatch.svg", title: "Smartwatch" },
  { src: "/images/devices/gameConsole.svg", title: "Game Console" },
];
export const repairElements = [
  {
